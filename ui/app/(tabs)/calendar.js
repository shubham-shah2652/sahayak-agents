      ...
      <View style={{ 
        ...
        <View style={{ flexDirection: 'row', marginTop: 15 }}>
          ...
          <TouchableOpacity style={{
            ...
            <Text style={{ color: COLORS.primary }}>Weekly</Text>
          </TouchableOpacity>
          <TouchableOpacity style={{
            backgroundColor: '#e0f2fe',
            paddingHorizontal: 20,
            ...
            <Text style={{ color: COLORS.primary }}>Daily</Text>
          </TouchableOpacity>
        </View>
      </View>
            ...
            <View key={index} style={{ 
              ...
              {!item.isEmpty && (
                <View style={{
                  ...
                  height: 30,
                  borderRadius: 15,
                  backgroundColor: item.day === selectedDay ? COLORS.primary : 'transparent',
                  justifyContent: 'center',
                  alignItems: 'center',
                  position: 'relative'
                }}>
                  ...
                  {[1, 2, 3, 4, 6, 7, 8, 9, 10, 13, 15, 16, 17, 19, 21, 22, 27, 31].includes(item.day) && (
                    <View style={{
                      ...
                      height: 4,
                      borderRadius: 2,
                      backgroundColor: item.day === selectedDay ? 'white' : COLORS.primary
                    }} />
                  )}
                </View>
              )}
          ...
          <View key={index} style={{
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <View style={{
                ...
                <MaterialIcons name={event.icon} size={20} color="white" />
              </View>
              <View style={{ flex: 1 }}>
                <Text style={{ fontSize: 16, fontWeight: 'bold', color: COLORS.primary }}>{event.title}</Text>
